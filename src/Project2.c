...
int main(void) {
    ...
    // FOR REFERENCE
    // BUTTON 1 = PORTAbits.RA2
    // BUTTON 2 = PORTBbits.RB4
    // BUTTON 3 = PORTAbits.RA4
...
//        char buffer[100];
//        uint16_t testnum = do_ADC();
//        sprintf(buffer, "\rADC Value: %d Period: %d\n", testnum, ((testnum * 1000) / 1023));    
//        Disp2String(buffer);
